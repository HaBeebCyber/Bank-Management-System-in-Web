...
<head>
    ...
    <title>Login - ABC Secure Bank</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center" style="height: 100vh;">
                <div class="col-7">
                    ...
                    <div class="col-md-12 fw-bold mb-5 text-center login-header">Welcome to ABC Secure Bank!</div>
            ...
            <div class="col-lg-6 align-items-center justify-content-center pb-5 d-none d-lg-flex"
                ...
                <a href="../index.php"><img src="../assets/img/logo.png" class="zoom-on-hover" alt="ABC Secure Logo"></a>
                <!-- Login Side Block -->
